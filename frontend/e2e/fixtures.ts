...
import { applyMocks, SESSION_STORAGE, PHASE3_STORE_RESET, PHASE4_STORE_RESET } from "./mocks/handlers";
...
export const test = base.extend({
  page: async ({ page }, use) => {
    ...
    await page.addInitScript(
      ...
      { sessionJson: SESSION_STORAGE, phase3Json: PHASE3_STORE_RESET, phase4Json: PHASE4_STORE_RESET },
    );
