...
- Generate a **design bundle** in a 4-section AI cascade (each section uses previous output as context for consistency), plus an independent 5th step:
...
- Persist locked artefacts into non-overlapping files:
  ...
  - `runtime-spec.md` — the **Runtime Contract** (optional); injected into Phase 3 task decomposition + developer packs, and probed by Phase 6 conformance
  - `tech-stack.md`
  - `story-index.json`
...
| `runtime-spec.md` | The **Runtime Contract** from Phase 2 (optional) — app/source paths, migration tool + command, session/bootstrap strategy, container topology, First Prototype Path; injected into Phase 3 task decomposition + developer packs, probed by Phase 6 conformance. Locks/relocks independently of `technical-spec.md` |
