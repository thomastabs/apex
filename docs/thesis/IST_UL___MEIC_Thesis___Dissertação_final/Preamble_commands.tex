...
% [1], [2], [5]--[7], [9]
% Commented out 2026-09-13: only useful with a numeric bibliography style;
% main.tex now uses apalike (author-year), which this package doesn't apply
% to and would do nothing for.
%\usepackage{cite}
%
% -----------------------------------------------------------------------------
% PACKAGE acronym:
