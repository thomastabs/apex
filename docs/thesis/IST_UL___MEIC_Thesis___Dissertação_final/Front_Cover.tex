...
% as the title beneath it. Pre-sized to 12.6cm x 6.6cm via its embedded DPI
% tag (no width option available on \thesislogo itself); y=40mm centres it in
% the gap between the university logo and the title block, leaving a ~5mm
