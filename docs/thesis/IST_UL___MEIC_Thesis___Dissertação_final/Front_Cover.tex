...
% shape itself carries the cyclic meaning without extra arrows. x=2.5cm
...
% as the title beneath it. Pre-sized to 6cm square via its embedded DPI tag
% (no width option available on \thesislogo itself) to fit the gap between
% the university logo and the title block.
\thesislogo{2.5cm}{45mm}{./Images/lifecycle-diagram-cover.png}
%
% -----------------------------------------------------------------------------
