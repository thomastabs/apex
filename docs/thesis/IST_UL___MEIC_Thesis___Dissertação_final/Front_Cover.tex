...
% lifecycle diagram (also Figure 6.1 in Chapter 6), placed above the title.
% Images/lifecycle-diagram.png is pre-sized to 14cm wide via its embedded
% DPI tag (no width option available on \thesislogo itself).
\thesislogo{35mm}{70mm}{./Images/lifecycle-diagram.png}
%
% -----------------------------------------------------------------------------
