...
% clutter. x=2.5cm matches the title textblock's own left origin in
% cover-titlepage.sty, so \centering (already set there) centers this image
% on the exact same span as the title beneath it. Pre-sized to 14cm wide via
% its embedded DPI tag (no width option available on \thesislogo itself).
\thesislogo{2.5cm}{70mm}{./Images/lifecycle-diagram-cover.png}
%
% -----------------------------------------------------------------------------
