...
% room), then nudged back up a touch ("just a tiny bit bigger") - final size
% 10.7cm x 5.6cm via its embedded DPI tag (no width option available on
% \thesislogo itself); y=40mm unchanged, leaving ~1.5cm of clear space
% before the title block (was ~4mm before the first shrink).
