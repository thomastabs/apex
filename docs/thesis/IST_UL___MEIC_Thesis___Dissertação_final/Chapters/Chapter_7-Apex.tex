...
Spec-Anchored Continuity & Versioned Markdown context files plus a story index under a per-tenant, per-project path, split into project-wide files and per-story specifications. & Realised \\ \addlinespace
