...
\todo[inline]{Close by restating how the framework answers DRQ1 and DRQ2, and hand over to \Cref{chap:apex}, which demonstrates that these constructs are implementable rather than merely describable.}
