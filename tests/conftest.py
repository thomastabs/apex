...
def _bypass_pm_auth(request, monkeypatch):
    ...
    monkeypatch.setattr(deps, "_resolve_anchor_base", lambda override="", plane_override="": ("taiga", "https://api.taiga.io/api/v1"))
    ...
    monkeypatch.setattr(deps, "resolve_account_id", lambda token, taiga_url_override="", plane_url_override="": "")
    yield
